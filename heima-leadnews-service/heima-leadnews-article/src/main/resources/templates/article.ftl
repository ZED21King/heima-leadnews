...
<#--    <link rel="stylesheet" href="../../../plugins/css/index.css">-->
    <link rel="stylesheet" href="/leadnews/resources/css/index.css">
</head>
...
<script src="/leadnews/resources/js/axios.min.js"></script>
<!-- 页面逻辑 -->
<#--<script src="../../../plugins/js/index.js"></script>-->
<script src="/leadnews/resources/js/index.js"></script>
</body>
